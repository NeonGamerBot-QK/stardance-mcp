...
export const finishedJobsTool = {
    name: "finished-jobs",
    desc: "List all finished jobs (requires admin access)",
    inputSchema: {
        jobClassName: {
            type: "string",
    ...
    async execute(_args, session) {
        ...
        const baseUrl = "https://stardance.hackclub.com/admin/jobs/applications/battlemage/finished/jobs"
